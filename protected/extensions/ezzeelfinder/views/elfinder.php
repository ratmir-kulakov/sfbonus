...
Yii::app()->clientScript->registerScriptFile($this->elFinderJsUrl . "/elfinder.min.js", CClientScript::POS_END);
...
if (isset($this->clientOptions['lang']) && $this->clientOptions['lang'])
    Yii::app()->clientScript->registerScriptFile($this->elFinderJsUrl . "/i18n/elfinder." . $this->clientOptions['lang'] . ".js", CClientScript::POS_END);

// Registering ElFinder's initialization script
Yii::app()->clientScript->registerScriptFile($this->initJsUrl, CClientScript::POS_END);
